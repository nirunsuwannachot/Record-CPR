...
<head>
    ...
    <title>ACLS Pro 2026 - Real-time Edition</title>
...
<body>
    ...
    <div id="main-app" class="flex flex-col h-full">
        ...
        <!-- Log Table with Real-time Timestamp -->
        ...
        <!-- Bottom Footer -->
        <div class="bg-white border-t p-3 flex items-center gap-3">
            ...
            <div class="flex gap-1.5 flex-1">
                ...
                <div class="bg-blue-600 text-white flex-1 py-1 rounded-xl text-center"><p class="text-[7px] uppercase mt-1">Epinephrine</p><p id="dash-epi" class="text-xl font-black">0</p></div>
            </div>
